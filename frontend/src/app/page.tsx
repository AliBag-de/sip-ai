...
export default function AudioWebSocket() {
  ...
  const handleAudioContext = useCallback(async (base64Data: string) => {
    try {
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">
            SIP-AI-Text Synthesiser
          </h1>
          <p className="text-gray-600 mb-8">
            Use the microphone or upload an audio file</p>
          ...
          <div className="mb-6">
            ...
            <button
              ...
              className={`w-full py-4 px-6 rounded-xl font-semibold text-white transition-all flex items-center justify-center gap-3 ${isStreaming
          ...
          <div className=''>
            ...
            <label
              className={`w-full py-4 px-6 rounded-xl font-semibold text-white transition-all flex items-center justify-center gap-3 cursor-pointer ${(isConnected)
            ...
            <div className=' ring ring-blue-100 bg-blue-300'>
              {
                transcripts.map((message, index) => {
                  return <p key={index} className={`text-black  p-1 ${message!.type === "assistant" ? "bg-emerald-200" : "bg-red-200"}`}>{message!.data}
                  </p>
            ...
            <div className="mb-2 p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg border border-purple-200">
              <div className="flex justify-between items-center">
                ...
                <div className="flex gap-2 items-center">
                  ...
                  {isStreaming ?
                    <span className="text-sm font-semibold text-red-600">Streaming</span>
                    :
                    <span className="text-sm font-semibold text-gray-600">Not streaming</span>
